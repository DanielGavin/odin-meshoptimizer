...
foreign meshoptimizer {
	...
	generateAdjacencyIndexBuffer :: proc(
		...
		indices: ^_c.uint,
		index_count: uint,
		vertex_positions: ^_c.float,
		vertex_count: uint,
		vertex_positions_stride: uint,
	) ---
	...
	buildMeshlets :: proc(
		meshlets: ^Meshlet,
		meshlet_vertices: ^_c.uint,
		meshlet_triangles: ^_c.uchar,
		indices: ^_c.uint,
		index_count: uint,
		vertex_positions: ^_c.float,
		vertex_count: uint,
	...
	setAllocator :: proc(
		allocate: (proc "c" (_: uint) -> rawptr),
		deallocate: proc "c" (_: rawptr),
	) ---
	...
	simplify :: proc(
		...
		vertex_count: uint,
		vertex_positions_stride: uint,
		target_index_count: uint,
		target_error: _c.float,
